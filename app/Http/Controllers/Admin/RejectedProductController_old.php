...
class RejectedProductController extends Controller
{
    ...
    {
        return view('admin.products.rejected');
    }
            ...
            ->addColumn('action', function($product) {
                    return '
                        <div class="d-flex gap-2">
                            <a href="'.route('admin.products.rejected.show', $product->id).'" class="btn btn-sm btn-soft-info">
                                <i class="bi bi-eye"></i> 
                            </a>
                            <button class="btn btn-sm btn-soft-warning restore-product" data-id="'.$product->id.'">
    ...
    public function restore($id)
    {
        ...
        return response()->json([
            'success' => true,
            'message' => 'Product restored to pending successfully!'
        ]);
    }
}