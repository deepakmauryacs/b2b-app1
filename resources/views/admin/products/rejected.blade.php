                ...
                <div class="table-responsive px-4 mb-3">
                    <table class="table align-middle mb-0 table-striped table-centered" id="approved-products-table" style="width: 100%;">
                        ...
                        <tbody id="products-table-body-content">
                            <tr><td colspan="10" class="text-center">Loading Vendors...</td></tr>
                        </tbody>
...
$(document).ready(function () {
    ...
    function fetchProductsData(page = 1, perPage = null) {
        ...
        $('#products-table-body-content').html('<tr><td colspan="10" class="text-center"><div class="spinner-border text-primary" role="status"><span class="visually-hidden">Loading...</span></div></td></tr>');
        ...
        currentAjaxRequest = $.ajax({
            url: "{{ route('admin.rejected.products.render-table') }}",
            method: 'GET',
            data: {
                page: page,
                per_page: perPage,
            ...
            error: function(xhr) {
                ...
                $('#products-table-body-content').html('<tr><td colspan="10" class="text-center text-danger">Error loading vendors. Please try again.</td></tr>');
            },
            complete: function() {
