...
<style>
    .product-image {
        ...
        display: block; /* Ensures image takes its own line below the label */
    ...
    .detail-label {
        font-weight: bold;
        color: #495057; /* Slightly darker than default text for labels */
        ...
        <div class="card">
            ...
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex gap-2 align-items-center">
                    ...
                    {{-- Back to List Button --}}
                    <a href="javascript:void(0);" onclick="window.history.back();" class="badge border border-secondary text-secondary px-2 py-1 fs-13">
                        ← Back to List
                    </a>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control-plaintext" value="{{ $product->product_name ?? 'N/A' }}" disabled>
                    </div>
                    <div class="col-md-6 mb-3">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control-plaintext" value="{{ $product->vendor->name ?? 'N/A' }}" disabled>
                    </div>
                    <div class="col-md-6 mb-3">
