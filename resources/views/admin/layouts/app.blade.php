                    ...
                    <div class="collapse" id="sidebarCategory">
                        <ul class="nav sub-navbar-nav">
                            <li class="sub-nav-item">
                                <a class="sub-nav-link" href="{{ route('admin.categories.index') }}">Category List</a>
                            </li>
                        </ul>
                    </div>
                </li>
                        ...
                        <ul class="nav sub-navbar-nav">
                            ...
                            <li class="sub-nav-item">
                                <a class="sub-nav-link" href="{{ route('admin.products.pending') }}">
                                    <span class="nav-text"> Product </span>&nbsp;&nbsp;  <span class="badge bg-primary-subtle text-primary py-1 px-2">Pending</span>
                                </a>
                            </li>
