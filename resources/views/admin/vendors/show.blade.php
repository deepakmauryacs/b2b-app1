                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    <p class="form-control-static">
                                        ...
                                        <span class="badge {{ $vendor->is_profile_verified == '1' ? 'bg-success' : 'bg-secondary' }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    @if($vendor->gst_doc)
                                        @if(pathinfo($vendor->gst_doc, PATHINFO_EXTENSION) === 'pdf')
                                            <a href="{{ asset($vendor->gst_doc) }}" target="_blank" class="btn btn-sm btn-outline-primary mt-2">
                                                <i class="bi bi-file-earmark-pdf"></i> View PDF Document
                                            </a>
                                        @else
                                            <a href="{{ asset($vendor->gst_doc) }}" target="_blank" class="mt-2 d-inline-block">
                                                <img src="{{ asset($vendor->gst_doc) }}" alt="GST Document" class="img-thumbnail" style="max-height: 200px;">
                                            </a>
                                        @endif
                                    @else
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    @if($vendor->store_logo)
                                        <img src="{{ asset($vendor->store_logo) }}" alt="Store Logo" class="img-thumbnail mt-2" style="max-height: 200px;">
                                    @else
                            ...
                            <div class="card-body">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" 
                                           id="accept_terms" {{ $vendor->accept_terms ? 'checked' : 'disabled' }}>
