                    ...
                    <form action="{{ route('admin.vendors.update', $vendor->id) }}" method="POST" id="vendorForm"
                        ...
                        <div class="row gy-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="status" id="status" class="form-select" required>
                                    <option value="1" {{ old('status', $vendor->status) == '1' ? 'selected' : '' }}>
                                        Active</option>
                                    <option value="2" {{ old('status', $vendor->status) == '2' ? 'selected' : '' }}>
                                        Inactive</option>
                                </select>
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="address" id="address" class="form-control" rows="3" placeholder="Enter full address">{{ old('address', $vendor->address) }}</textarea>
                            </div>
