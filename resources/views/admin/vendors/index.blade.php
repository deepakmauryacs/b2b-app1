...
function fetchVendorsData(page = 1, perPage = null) {
    ...
    $('#vendors-table-body-content').html('<tr><td colspan="10" class="text-center"><div class="spinner-border text-primary" role="status"><span class="visually-hidden">Loading...</span></div></td></tr>');
    ...
    currentAjaxRequest = $.ajax({
        ...
        error: function(xhr) {
            ...
            $('#vendors-table-body-content').html('<tr><td colspan="10" class="text-center text-danger">Error loading vendors. Please try again.</td></tr>');
        },
        complete: function() {
