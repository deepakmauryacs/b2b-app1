                    ...
                    <tbody>
                        @foreach([
                            ...
                            <tr>
                                ...
                                <td>{{ $order['date'] }}</td>
                                <td><img src="{{ asset('assets/images/products/' . $order['product']) }}" alt="{{ $order['product'] }}" class="img-fluid avatar-sm"></td>
                                <td><a href="#!">{{ $order['customer'] }}</a></td>
                                <td>{{ $order['email'] }}</td>
                                <td>{{ $order['phone'] }}</td>
                                <td>{{ $order['address'] }}</td>
                                <td>{{ $order['payment'] }}</td>
                                <td><i class="bx bxs-circle text-{{ $order['status_type'] }} me-1"></i>{{ $order['status'] }}</td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
